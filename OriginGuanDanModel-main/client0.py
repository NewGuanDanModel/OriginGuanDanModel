    ...
    def received_message(self, message):
        ...
        if message['type'] == 'notify':
            ...
            if message['stage'] == 'beginning':
                ...
                with open('play_data.txt', 'a+') as f:
                    f.write(
                        f"Player0 initial handcard is {card2str(message['handCards'])}\n")
                    f.close()
            # 记录进贡的牌
                ...
                for i in range(tribute_num):
                    ...
                    print(
                        f"Player{temp[0]} tributes {card2str([temp[2]])} to Player{temp[1]}")
                    with open('play_data.txt', 'a+') as f:
                        f.write(
                            f"Player{temp[0]} tribute {card2str([temp[2]])} to Player{temp[1]}\n")
                        f.close()
            # 在动作序列中记录动作
                ...
                if just_play != self.mypos:
                    with open('play_data.txt', 'a+') as f:
                        f.write(
                            f"Player{just_play} action is {card2str(message['curAction'][2])}\n")
                        f.close()
                ...
                with open('play_data.txt', 'a+') as f:
                    if len(message['result']) == 1:
                        print(
                            f"Player{message['result'][0][0]} gives {card2str([message['result'][0][2]])} back to Player{message['result'][0][1]}")
                        f.write(
                            f"Player{message['result'][0][0]} gives {card2str([message['result'][0][2]])} back to Player{message['result'][0][1]}\n")
                    else:
                        print(
                        ...
                        f.write(
                            f"Player{message['result'][0][0]} gives {card2str([message['result'][0][2]])} back to Player{message['result'][0][1]}\n")
                        print(
                            f"Player{message['result'][1][0]} gives {card2str([message['result'][1][2]])} back to Player{message['result'][1][1]}")
                        f.write(
                            f"Player{message['result'][1][0]} gives {card2str([message['result'][1][2]])} back to Player{message['result'][1][1]}\n")
                    f.close()
                print("====================================")
        ...
        # 需要做动作
            ...
            # 打牌
                ...
                print(
                    f"Your choice is {message['actionList'][int(choice[1])]}!")
                print("======================================================")
                with open('play_data.txt', 'a+') as f:
                    f.write(
                        f"Player0 action is {card2str(message['actionList'][int(choice[1])][2])}\n")
                    f.close()
        ...
        if message['stage'] == 'episodeOver':
            ...
            with open('human_vs_model.log', 'a+') as f:
                f.write(f"========================\n")
                f.write(f"human vs train19/24500\n")
                value = 0.0
                d = 1.0
